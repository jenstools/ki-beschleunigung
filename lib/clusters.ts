...
export const CLUSTERS: Cluster[] = [
  {
    path: "/tempo",
    title: "Das Tempo: aus 24 Tagen Abstand wurden 2,5",
    short: "Tempo",
    claim:
      "2022 lagen zwischen zwei fähigkeitsverändernden KI-Releases im Schnitt 24,2 Tage. 2026 sind es 2,5. Im laufenden Halbjahr ist es genau ein Tag — 15 der 32 Releases im Juli 2026 fielen auf einen Tag, an dem es noch ein weiteres gab.",
    description:
      "Wie stark der Abstand zwischen zwei fähigkeitsverändernden KI-Releases geschrumpft ist: 24,2 Tage im Jahr 2022, 2,5 im Jahr 2026. Halbjahresweise gemessen an 249 primärgeprüften Releases, mit den längsten Pausen und den dichtesten Wochen.",
    api: "/api/v1/tempo",
    verify: (rel) => {
      ...
      expect("Abstand 2026", round(years[years.length - 1].meanGap, 1), 2.5);
      expect(
      ...
      expect("Releases gesamt", rel.length, 249);
    },
  },
  {
    path: "/erstmalig",
    ...
    short: "Erstmalig",
    claim:
      "114 von 249 Releases tragen einen belegten „Erster, der …“-Anspruch: 40 in Text, 27 in Audio, 26 in Video, 21 in Bild. 41 davon kamen mit offenen Gewichten. Bei 8 ist der Anspruch oder das Datum strittig — mit Begründung, warum.",
    description:
  ...
  },
  {
    ...
    description:
      "Offene gegen geschlossene Gewichte über vier Jahre: Höchststand 38 % im Jahr 2023, Tiefpunkt 17 % im Jahr 2025, dazwischen eine Lücke von 194 Tagen ohne einen einzigen offenen Release. Mit allen 74 offenen Releases, Primärquellen und der Aufschlüsselung nach Modalität und Haus.",
    ...
    verify: (rel) => {
      ...
      expect("Offene Releases gesamt", open.length, 74);
      expect("Releases gesamt", rel.length, 249);
